...
## Installing Plugins[¶](#installing-plugins "Link to this heading")
...
## Using Plugins in Projects[¶](#using-plugins-in-projects "Link to this heading")
...
### A note on Renderer Compatibility[¶](#a-note-on-renderer-compatibility "Link to this heading")
...
* [Plugins](#)
  ...
  + [Creating Plugins](#creating-plugins)
    - [A note on Renderer Compatibility](#a-note-on-renderer-compatibility)