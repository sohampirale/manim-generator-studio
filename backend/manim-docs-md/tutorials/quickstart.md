Quickstart - Manim Community v0.19.0
...
* [Quickstart](#)
  ...
  + [Animating a circle](#animating-a-circle)
    - [Explanation](#explanation)
  + [Transforming a square into a circle](#transforming-a-square-into-a-circle)
  + [Positioning `Mobject`s](#positioning-mobjects)
  + [Using `.animate` syntax to animate methods](#using-animate-syntax-to-animate-methods)
  + [`Transform` vs `ReplacementTransform`](#transform-vs-replacementtransform)
