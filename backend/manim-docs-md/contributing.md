Contributing - Manim Community v0.19.0
...
members of the community. If you haven’t read our [code of conduct](conduct.html),
...
* [Manim Development Process](contributing/development.html)
  + [For first-time contributors](contributing/development.html#for-first-time-contributors)
  + [Develop your contribution](contributing/development.html#develop-your-contribution)
  + [Polishing Changes and Submitting a Pull Request](contributing/development.html#polishing-changes-and-submitting-a-pull-request)
    - [Further useful guidelines](contributing/development.html#further-useful-guidelines)
* [Adding Documentation](contributing/docs.html)
  + [Building the documentation](contributing/docs.html#building-the-documentation)
  + [Sphinx library and extensions](contributing/docs.html#sphinx-library-and-extensions)
  + [Sphinx theme](contributing/docs.html#sphinx-theme)
  + [Custom Sphinx directives](contributing/docs.html#custom-sphinx-directives)
  + [Index](contributing/docs.html#index)
    - [Adding Admonitions](contributing/docs/admonitions.html)
    - [Adding Docstrings](contributing/docs/docstrings.html)
    - [Adding Examples](contributing/docs/examples.html)
    - [Adding References](contributing/docs/references.html)
    ...
    - [Choosing Type Hints](contributing/docs/types.html)
* [Adding Tests](contributing/testing.html)
  + [How Manim tests](contributing/testing.html#how-manim-tests)
    - [How it Works](contributing/testing.html#how-it-works)
  + [Architecture](contributing/testing.html#architecture)
  + [The Main Directories](contributing/testing.html#the-main-directories)
  + [Adding a New Test](contributing/testing.html#adding-a-new-test)
    - [Unit Tests](contributing/testing.html#unit-tests)
    - [Graphical Unit Test](contributing/testing.html#graphical-unit-test)
    - [Videos tests](contributing/testing.html#videos-tests)
* [Improving performance](contributing/performance.html)
  + [Profiling](contributing/performance.html#profiling)
    - [Running an animation as a script](contributing/performance.html#running-an-animation-as-a-script)
    - [An example: profiling with cProfile and SnakeViz](contributing/performance.html#an-example-profiling-with-cprofile-and-snakeviz)
* [Internationalization](contributing/internationalization.html)
  + [Signing up](contributing/internationalization.html#signing-up)
  + [Contributing](contributing/internationalization.html#contributing)
    - [Voting](contributing/internationalization.html#voting)
    - [Translations](contributing/internationalization.html#translations)
  + [Translation guidelines](contributing/internationalization.html#translation-guidelines)
  + [Proofreading](contributing/internationalization.html#proofreading)
  + [Errors](contributing/internationalization.html#errors)
    - [Source errors](contributing/internationalization.html#source-errors)
