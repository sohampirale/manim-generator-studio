FAQ: Getting Help - Manim Community v0.19.0
...
## How do I animate X? Why do I get error Y? Can someone help me?[¶](#how-do-i-animate-x-why-do-i-get-error-y-can-someone-help-me "Link to this heading")
...
## What should I do if nobody answers my question?[¶](#what-should-i-do-if-nobody-answers-my-question "Link to this heading")
...
## The library does not behave as documented, or something broke in a new release. What should I do?[¶](#the-library-does-not-behave-as-documented-or-something-broke-in-a-new-release-what-should-i-do "Link to this heading")
...
## I have an idea for a really cool feature that should be implemented, where should I share my idea?[¶](#i-have-an-idea-for-a-really-cool-feature-that-should-be-implemented-where-should-i-share-my-idea "Link to this heading")
...
* [FAQ: Getting Help](#)
  + [How do I animate X? Why do I get error Y? Can someone help me?](#how-do-i-animate-x-why-do-i-get-error-y-can-someone-help-me)
  + [What should I do if nobody answers my question?](#what-should-i-do-if-nobody-answers-my-question)
  + [The library does not behave as documented, or something broke in a new release. What should I do?](#the-library-does-not-behave-as-documented-or-something-broke-in-a-new-release-what-should-i-do)
  + [I have an idea for a really cool feature that should be implemented, where should I share my idea?](#i-have-an-idea-for-a-really-cool-feature-that-should-be-implemented-where-should-i-share-my-idea)