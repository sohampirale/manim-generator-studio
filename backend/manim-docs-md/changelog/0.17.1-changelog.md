v0.17.1 - Manim Community v0.19.0
...
# v0.17.1[¶](#v0-17-1 "Link to this heading")
...
* [#3062](https://github.com/ManimCommunity/manim/pull/3062): Added Unicode encoding in [`Scene.add_subcaption()`](../reference/manim.scene.scene.Scene.html#manim.scene.scene.Scene.add_subcaption "manim.scene.scene.Scene.add_subcaption")

### Documentation-related changes[¶](#documentation-related-changes "Link to this heading")

* [#2953](https://github.com/ManimCommunity/manim/pull/2953): Added documentation for lagged animations in [`animation.composition`](../reference/manim.animation.composition.html#module-manim.animation.composition "manim.animation.composition")
