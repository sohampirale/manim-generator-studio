v0.1.1 - Manim Community v0.19.0
...
# v0.1.1[¶](#v0-1-1 "Link to this heading")
...
1. Provided a standardized method for plugin discoverability, creation,
   installation, and usage. See the [documentation](../plugins.html#plugins).
...
3. Remove some unnecessary or unpythonic methods from [`Scene`](../reference/manim.scene.scene.Scene.html#manim.scene.scene.Scene "manim.scene.scene.Scene")
   (`get_mobjects`, `add_mobjects_among`, `get_mobject_copies`),
   via [#758](https://github.com/ManimCommunity/manim/pull/758).
4. Fix formatting of [`Code`](../reference/manim.mobject.text.code_mobject.Code.html#manim.mobject.text.code_mobject.Code "manim.mobject.text.code_mobject.Code") (via [#798](https://github.com/ManimCommunity/manim/pull/798)).
...
2. The global `config` dict has been replaced by a global `config` instance
   of the new class [`ManimConfig`](../reference/manim._config.utils.ManimConfig.html#manim._config.utils.ManimConfig "manim._config.utils.ManimConfig"). This class has a dict-like API, so
...
## Mobjects, Scenes, and Animations[¶](#mobjects-scenes-and-animations "Link to this heading")

1. The `alignment` attribute to Tex and MathTex has been removed in favour of `tex_environment`.
2. [`Text`](../reference/manim.mobject.text.text_mobject.Text.html#manim.mobject.text.text_mobject.Text "manim.mobject.text.text_mobject.Text") now uses Pango for rendering. `PangoText` has been removed. The old implementation is still available as a fallback as `CairoText`.
3. Variations of [`Dot`](../reference/manim.mobject.geometry.arc.Dot.html#manim.mobject.geometry.arc.Dot "manim.mobject.geometry.arc.Dot") have been added as [`AnnotationDot`](../reference/manim.mobject.geometry.arc.AnnotationDot.html#manim.mobject.geometry.arc.AnnotationDot "manim.mobject.geometry.arc.AnnotationDot")
   (a bigger dot with bolder stroke) and [`LabeledDot`](../reference/manim.mobject.geometry.arc.LabeledDot.html#manim.mobject.geometry.arc.LabeledDot "manim.mobject.geometry.arc.LabeledDot") (a dot containing a
   label).
4. Scene.set\_variables\_as\_attrs has been removed (via [#692](https://github.com/ManimCommunity/manim/pull/692)).
5. Ensure that the axes for graphs (`GraphScene`) always intersect ([#580](https://github.com/ManimCommunity/manim/pull/580)).
6. Now Mobject.add\_updater does not call the newly-added updater by default
   (use `call_updater=True` instead) (via [#710](https://github.com/ManimCommunity/manim/pull/710))
7. VMobject now has methods to determine and change the direction of the points (via [#647](https://github.com/ManimCommunity/manim/pull/647)).
8. Added BraceBetweenPoints (via [#693](https://github.com/ManimCommunity/manim/pull/693)).
9. Added ArcPolygon and ArcPolygonFromArcs (via [#707](https://github.com/ManimCommunity/manim/pull/707)).
...
12. Added [`ManimBanner`](../reference/manim.mobject.logo.ManimBanner.html#manim.mobject.logo.ManimBanner "manim.mobject.logo.ManimBanner") for a animated version of our logo and banner (via [#729](https://github.com/ManimCommunity/manim/pull/729))
...
* [v0.1.1](#)
  ...
  + [Mobjects, Scenes, and Animations](#mobjects-scenes-and-animations)