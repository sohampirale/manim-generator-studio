Improving performance - Manim Community v0.19.0
...
### Running an animation as a script[¶](#running-an-animation-as-a-script "Link to this heading")
...
### An example: profiling with cProfile and SnakeViz[¶](#an-example-profiling-with-cprofile-and-snakeviz "Link to this heading")
...
![../_images/snakeviz.png](../_images/snakeviz.png)
...
* [Improving performance](#)
  + [Profiling](#profiling)
    - [Running an animation as a script](#running-an-animation-as-a-script)
    - [An example: profiling with cProfile and SnakeViz](#an-example-profiling-with-cprofile-and-snakeviz)