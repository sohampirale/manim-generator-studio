Manim Development Process - Manim Community v0.19.0
...
# Manim Development Process[¶](#manim-development-process "Link to this heading")

## For first-time contributors[¶](#for-first-time-contributors "Link to this heading")
...
7. Install Manim:
   ...
   * Follow the steps in our [installation instructions](../installation.html) to install **Manim’s system dependencies**.
...
## Develop your contribution[¶](#develop-your-contribution "Link to this heading")
...
4. Add new or update existing tests.
   ...
   our testing system are explained in the [testing guide](testing.html).
5. Update docstrings and documentation:
   ...
   See the [documentation guide](docs/docstrings.html) for more information about how we
   prefer our code to be documented. The content of the docstrings will be
   rendered in the [reference manual](../reference.html).

   Tip

   Use the [`manim directive for Sphinx`](../reference/manim.utils.docbuild.manim_directive.html#module-manim.utils.docbuild.manim_directive "manim.utils.docbuild.manim_directive") to add examples
   to the documentation!

As far as development on your local machine goes, these are the main steps you
should follow.

## Polishing Changes and Submitting a Pull Request[¶](#polishing-changes-and-submitting-a-pull-request "Link to this heading")
...
2. Make a pull request (PR) on GitHub.
   ...
   ![../_images/pull-requests.png](../_images/pull-requests.png)
...
* **Documentation**: We also build a version of the documentation corresponding
  ...
  installed locally in order to build the inheritance diagrams. See [Adding Documentation](docs.html) for
  more information.
...
### Further useful guidelines[¶](#further-useful-guidelines "Link to this heading")
...
the [Example Gallery](../examples.html), [Tutorials](../tutorials/index.html),
and [Reference Classes](../reference.html).
...
* [Manim Development Process](#)
  ...
  + [Polishing Changes and Submitting a Pull Request](#polishing-changes-and-submitting-a-pull-request)
    - [Further useful guidelines](#further-useful-guidelines)