Adding Documentation - Manim Community v0.19.0
...
* [Contributing](../contributing.html)
  ...
  + [Adding Documentation](#)
    ...
    - [Adding Admonitions](docs/admonitions.html)
    - [Adding Docstrings](docs/docstrings.html)
    - [Adding Examples](docs/examples.html)
    - [Adding References](docs/references.html)
    - [Typing Conventions](docs/typings.html)
    - [Choosing Type Hints](docs/types.html)
...
# Adding Documentation[¶](#adding-documentation "Link to this heading")
...
## Sphinx library and extensions[¶](#sphinx-library-and-extensions "Link to this heading")
...
* [Graphviz extension for Sphinx:](https://www.sphinx-doc.org/en/master/usage/extensions/graphviz.html)
  ...
  inheritance diagrams in the [Reference Manual](../reference.html).
* [Napoleon:](https://www.sphinx-doc.org/en/master/usage/extensions/napoleon.html)
  ...
  - see [Adding Docstrings](docs/docstrings.html) for more information.

## Sphinx theme[¶](#sphinx-theme "Link to this heading")

The theme used for this website is [Furo](https://sphinx-themes.org/sample-sites/furo/).

## Custom Sphinx directives[¶](#custom-sphinx-directives "Link to this heading")

Manim implements **custom directives** for use with Autodoc and Autosummary, which
are defined in [`docbuild`](../reference/manim.utils.docbuild.html#module-manim.utils.docbuild "manim.utils.docbuild"):

|  |  |
| --- | --- |
| [`autoaliasattr_directive`](../reference/manim.utils.docbuild.autoaliasattr_directive.html#module-manim.utils.docbuild.autoaliasattr_directive "manim.utils.docbuild.autoaliasattr_directive") | A directive for documenting type aliases and other module-level attributes. |
| [`autocolor_directive`](../reference/manim.utils.docbuild.autocolor_directive.html#module-manim.utils.docbuild.autocolor_directive "manim.utils.docbuild.autocolor_directive") | A directive for documenting colors in Manim. |
| [`manim_directive`](../reference/manim.utils.docbuild.manim_directive.html#module-manim.utils.docbuild.manim_directive "manim.utils.docbuild.manim_directive") | A directive for including Manim videos in a Sphinx document |

## Index[¶](#index "Link to this heading")

* [Adding Admonitions](docs/admonitions.html)
  + [Adding Blocks for Tip, Note, Important etc. (Admonitions)](docs/admonitions.html#adding-blocks-for-tip-note-important-etc-admonitions)
* [Adding Docstrings](docs/docstrings.html)
  + [Formatting the Docstrings](docs/docstrings.html#formatting-the-docstrings)
  + [NumPy Format](docs/docstrings.html#numpy-format)
* [Adding Examples](docs/examples.html)
  + [Guidelines for examples](docs/examples.html#guidelines-for-examples)
  + [What makes a great example](docs/examples.html#what-makes-a-great-example)
  + [How examples are structured](docs/examples.html#how-examples-are-structured)
* [Adding References](docs/references.html)
  + [Reference to types in documentation](docs/references.html#reference-to-types-in-documentation)
* [Typing Conventions](docs/typings.html)
  + [Adding type hints to functions and parameters](docs/typings.html#adding-type-hints-to-functions-and-parameters)
  + [Missing Sections for typehints are:](docs/typings.html#missing-sections-for-typehints-are)
* [Choosing Type Hints](docs/types.html)
  + [Coordinates](docs/types.html#coordinates)
  + [Colors](docs/types.html#colors)
  + [Béziers](docs/types.html#beziers)
  + [Functions](docs/types.html#functions)
  + [Images](docs/types.html#images)
...
* [Adding Documentation](#)
  ...
  + [Sphinx library and extensions](#sphinx-library-and-extensions)
