Adding References - Manim Community v0.19.0
...
# Adding References[¶](#adding-references "Link to this heading")

## Reference to types in documentation[¶](#reference-to-types-in-documentation "Link to this heading")
...
### Path specifications[¶](#path-specifications "Link to this heading")
...
### Reference type specifications[¶](#reference-type-specifications "Link to this heading")
...
* [Adding References](#)
  + [Reference to types in documentation](#reference-to-types-in-documentation)
    - [Path specifications](#path-specifications)
    - [Reference type specifications](#reference-type-specifications)