Choosing Type Hints - Manim Community v0.19.0
...
* [Contributing](../../contributing.html)
  ...
  + [Manim Development Process](../development.html)
  + [Adding Documentation](../docs.html)

    Toggle navigation of Adding Documentation

    - [Adding Admonitions](admonitions.html)
    - [Adding Docstrings](docstrings.html)
    - [Adding Examples](examples.html)
    - [Adding References](references.html)
    - [Typing Conventions](typings.html)
    - [Choosing Type Hints](#)
  + [Adding Tests](../testing.html)
  + [Improving performance](../performance.html)
...
# Choosing Type Hints[¶](#choosing-type-hints "Link to this heading")
...
[`Point3DLike`](../../reference/manim.typing.html#manim.typing.Point3DLike "manim.typing.Point3DLike") as a parameter and returns a [`Point3D`](../../reference/manim.typing.html#manim.typing.Point3D "manim.typing.Point3D"). A
[`Point3D`](../../reference/manim.typing.html#manim.typing.Point3D "manim.typing.Point3D") always represents a NumPy array consisting of 3 floats,
whereas a [`Point3DLike`](../../reference/manim.typing.html#manim.typing.Point3DLike "manim.typing.Point3DLike") can represent anything resembling a 3D point:
either a NumPy array or a tuple/list of 3 floats, hence the `Like` word. The
same happens with [`Point2D`](../../reference/manim.typing.html#manim.typing.Point2D "manim.typing.Point2D"), [`Point2D_Array`](../../reference/manim.typing.html#manim.typing.Point2D_Array "manim.typing.Point2D_Array") and
[`Point3D_Array`](../../reference/manim.typing.html#manim.typing.Point3D_Array "manim.typing.Point3D_Array"), and their `Like` counterparts
[`Point2DLike`](../../reference/manim.typing.html#manim.typing.Point2DLike "manim.typing.Point2DLike"), [`Point2DLike_Array`](../../reference/manim.typing.html#manim.typing.Point2DLike_Array "manim.typing.Point2DLike_Array") and
[`Point3DLike_Array`](../../reference/manim.typing.html#manim.typing.Point3DLike_Array "manim.typing.Point3DLike_Array").
...
### Vectors[¶](#vectors "Link to this heading")
...
typed as a [`Point3D`](../../reference/manim.typing.html#manim.typing.Point3D "manim.typing.Point3D"), because it represents a direction along
which to shift a [`Mobject`](../../reference/manim.mobject.mobject.Mobject.html#manim.mobject.mobject.Mobject "manim.mobject.mobject.Mobject"), not a position in space.

As a general rule, if a parameter is called `direction` or `axis`,
it should be type hinted as some form of [`VectorND`](../../reference/manim.typing.html#manim.typing.VectorND "manim.typing.VectorND").

Warning

This is not always true. For example, as of Manim 0.18.0, the direction
parameter of the [`Vector`](../../reference/manim.mobject.geometry.line.Vector.html#manim.mobject.geometry.line.Vector "manim.mobject.geometry.line.Vector") Mobject should be
...
The interface Manim provides for working with colors is [`ManimColor`](../../reference/manim.utils.color.core.ManimColor.html#manim.utils.color.core.ManimColor "manim.utils.color.core.ManimColor").
...
## Béziers[¶](#beziers "Link to this heading")

Manim internally represents a [`Mobject`](../../reference/manim.mobject.mobject.Mobject.html#manim.mobject.mobject.Mobject "manim.mobject.mobject.Mobject") by a collection of points. In the case of [`VMobject`](../../reference/manim.mobject.types.vectorized_mobject.VMobject.html#manim.mobject.types.vectorized_mobject.VMobject "manim.mobject.types.vectorized_mobject.VMobject"),
the most commonly used subclass of [`Mobject`](../../reference/manim.mobject.mobject.Mobject.html#manim.mobject.mobject.Mobject "manim.mobject.mobject.Mobject"), these points represent Bézier curves,
...
Type hints like [`BezierPoints`](../../reference/manim.typing.html#manim.typing.BezierPoints "manim.typing.BezierPoints") represent a single bezier curve, and [`BezierPath`](../../reference/manim.typing.html#manim.typing.BezierPath "manim.typing.BezierPath")
represents multiple Bézier curves. A [`Spline`](../../reference/manim.typing.html#manim.typing.Spline "manim.typing.Spline") is when the Bézier curves in a [`BezierPath`](../../reference/manim.typing.html#manim.typing.BezierPath "manim.typing.BezierPath")
forms a single connected curve. Manim also provides more specific type aliases when working with
quadratic or cubic curves, and they are prefixed with their respective type (e.g. [`CubicBezierPoints`](../../reference/manim.typing.html#manim.typing.CubicBezierPoints "manim.typing.CubicBezierPoints"),
is a [`BezierPoints`](../../reference/manim.typing.html#manim.typing.BezierPoints "manim.typing.BezierPoints") consisting of exactly 4 points representing a cubic Bézier curve).
...
Another example is for overriding animations. One will often need to map a [`Mobject`](../../reference/manim.mobject.mobject.Mobject.html#manim.mobject.mobject.Mobject "manim.mobject.mobject.Mobject")
to an overridden [`Animation`](../../reference/manim.animation.animation.Animation.html#manim.animation.animation.Animation "manim.animation.animation.Animation"), and for that we have the [`FunctionOverride`](../../reference/manim.typing.html#manim.typing.FunctionOverride "manim.typing.FunctionOverride") type hint.

[`PathFuncType`](../../reference/manim.typing.html#manim.typing.PathFuncType "manim.typing.PathFuncType") and [`MappingFunction`](../../reference/manim.typing.html#manim.typing.MappingFunction "manim.typing.MappingFunction") are more niche, but are related to moving objects
...
This is the use case of the [`PixelArray`](../../reference/manim.typing.html#manim.typing.PixelArray "manim.typing.PixelArray") type hint. Sometimes, Manim may use `PIL.Image.Image`,
which is not the same as [`PixelArray`](../../reference/manim.typing.html#manim.typing.PixelArray "manim.typing.PixelArray"). In this case, use the `PIL.Image.Image` typehint.
