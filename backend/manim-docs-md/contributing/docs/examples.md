Adding Examples - Manim Community v0.19.0
...
# Adding Examples[¶](#adding-examples "Link to this heading")
...
## Guidelines for examples[¶](#guidelines-for-examples "Link to this heading")
...
## What makes a great example[¶](#what-makes-a-great-example "Link to this heading")
...
## How examples are structured[¶](#how-examples-are-structured "Link to this heading")
...
`rst` format and use the manim directive (see [`manim.utils.docbuild.manim_directive`](../../reference/manim.utils.docbuild.manim_directive.html#module-manim.utils.docbuild.manim_directive "manim.utils.docbuild.manim_directive") ), `.. manim::`. Every example is in its own block, and looks like this:
...
All possible flags can be found at [`manim.utils.docbuild.manim_directive`](../../reference/manim.utils.docbuild.manim_directive.html#module-manim.utils.docbuild.manim_directive "manim.utils.docbuild.manim_directive").
...
* [Adding Examples](#)
  + [Guidelines for examples](#guidelines-for-examples)
  + [What makes a great example](#what-makes-a-great-example)
  + [How examples are structured](#how-examples-are-structured)
