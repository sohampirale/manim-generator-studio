Adding Tests - Manim Community v0.19.0
...
# Adding Tests[¶](#adding-tests "Link to this heading")
...
## How Manim tests[¶](#how-manim-tests "Link to this heading")
...
## The Main Directories[¶](#the-main-directories "Link to this heading")
...
## Adding a New Test[¶](#adding-a-new-test "Link to this heading")
...
### Graphical Unit Test[¶](#graphical-unit-test "Link to this heading")
...
### Videos tests[¶](#videos-tests "Link to this heading")
...
* [Adding Tests](#)
  + [How Manim tests](#how-manim-tests)
    - [How it Works](#how-it-works)
  + [Architecture](#architecture)
  + [The Main Directories](#the-main-directories)
  + [Adding a New Test](#adding-a-new-test)
    - [Unit Tests](#unit-tests)
    - [Graphical Unit Test](#graphical-unit-test)
    - [Videos tests](#videos-tests)